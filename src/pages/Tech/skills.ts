...
import djangoIcon from "./tech-icons/django.svg";
import dockerIcon from "./tech-icons/docker.svg";
...
import graphQLIcon from "./tech-icons/graphql.svg";
...
const skills = {
  backEnd: [
    ...
    ["Django", "https://www.djangoproject.com/", djangoIcon],
    ...
    ["GraphQL", "https://graphql.org/", graphQLIcon],
  ...
  frontEnd: [
    ...
    ["Bootstrap", "https://getbootstrap.com/", bootstrapIcon],
